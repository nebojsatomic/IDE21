	...
	init: function() {
		var self = this,
			...
			uiDialog = (this.uiDialog = uiDialogContainer.parent())
				...
				.attr('id', options.id)  // Added by Bojan Zivanovic
		...
		this.uiDialogTitlebarClose = $('.ui-dialog-titlebar-close', uiDialogTitlebar)
			...
			.click(function() {
				if($('#' + options.id + ' .d_cancel').css('display') != 'none') {
					$('#' + options.id + ' .d_cancel').trigger('click');
				} else {
					$('#' + options.id + ' .d_ok').trigger('click');
				}
