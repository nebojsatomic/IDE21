...
class CreateTemplatesSrTable extends Migration
{
    public function up()
    {
        if (!Schema::hasTable('templates_sr')) {
            Schema::create('templates_sr', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('templates_sr');
    }
}